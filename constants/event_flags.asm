...
; TODO: reorganize these when it's okay to break saves
	...
	const EVENT_VIOLET_OUTSKIRTS_HIDDEN_MISDREAVUS_ABANDONED_HOUSE
	const EVENT_VIOLET_OUTSKIRTS_MISDREAVUS_SEARCH_STARTED
	const EVENT_VIOLET_OUTSKIRTS_HIDDEN_MISDREAVUS_PHOTO
	const EVENT_VIOLET_OUTSKIRTS_HIDDEN_MISDREAVUS_FIREPLACE
	const EVENT_VIOLET_OUTSKIRTS_HIDDEN_MISDREAVUS_WOOD
	const EVENT_VIOLET_OUTSKIRTS_HIDDEN_MISDREAVUS_INCENSE_BURNER
	const EVENT_VIOLET_OUTSKIRTS_MISDREAVUS_SEARCH_COMPLETED
	const EVENT_VIOLET_OUTSKIRTS_MISDREAVUS_FIRST_ENCOUNTER
